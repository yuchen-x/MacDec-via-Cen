...
class ReplayMemory_rand_with_filter(ReplayMemory):

    def __init__(self, n_agent, obs_size, trace_len, batch_size, size=100000):
        super(ReplayMemory_rand_with_filter, self).__init__(n_agent, obs_size, batch_size, size)
        self.trace_len = trace_len
        self.scenario_cache_reset()
    ...
    def scenario_cache_reset(self):
        self.scenario_cache = self.ZERO_PADDING * (self.trace_len - 2) + self.ZEROS_ONE_PADDING
