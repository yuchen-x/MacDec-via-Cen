...
def QLearn_squ_dec_cen_0(env, agents, cen_controller, batches, hysteretic, discount, trace_lens, sub_trace_len, batch_size, sort_traj=False,
    ...
    cen_batch, dec_batch_cen, dec_batches = batches

    trace_len = trace_lens[0]
    ...
    trace_len = trace_lens[1]

    state_b, id_action_b, j_action_b, id_reward_b, j_reward_b, state_next_b, terminate_b, id_valid_b, j_valid_b = zip(*dec_batch_cen)
