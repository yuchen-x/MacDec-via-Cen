...
def train(env_name, grid_dim, obs_one_hot, target_flick_prob, agent_trans_noise, target_rand_move, 
          ...
          sort_traj, batch_norm, mlp_layer_size, rnn, rnn_input_dim, rnn_layer_num, rnn_h_size, gru, run_id, resume, save_ckpt, seed, save_dir, device, **kwargs):
    ...
    hyper_params = {'batch_norm': batch_norm,
...
def main():
    ...
    parser.add_argument('--l_rate', action='store', type=float, default=0.0003)
