...
def train(env_name, grid_dim, obs_one_hot, target_flick_prob, agent_trans_noise, target_rand_move, 
          h_speed_ps, tb_m_speed, tb_m_noisy, f_p_obj_tc, f_l_obj_tc, d_d_p,
...
def main():
    ...
    parser.add_argument('--d_d_p', action='store_true') # delay delivery penalty
    ...
    parser.add_argument('--l_mode', action='store', type=int, default=0)
    ...
    parser.add_argument('--cen_rnn_h_size', action='store', type=int, default=64)
